...
def a_console(fill=0):
    return ports.Console(models.describe("upd7725").build(fill=fill))


class StatusTest(unittest.TestCase):
    def test_the_console_reads_the_top_half_of_the_status_word(self):
        found = a_console()
    ...
    def test_the_part_says_when_it_wants_attention(self):
        found = a_console()
        found.chip.registers.sr.rqm = True
...
class TransferTest(unittest.TestCase):
    def test_a_wide_transfer_takes_the_low_half_first(self):
        found = a_console()
    ...
    def test_and_hands_it_back_the_same_way_round(self):
        found = a_console()
        found.chip.registers.dr = 0x1234

        self.assertEqual((found.read(ports.DATA), found.read(ports.DATA)), (0x34, 0x12))

    def test_a_narrow_transfer_moves_one_half_at_a_time(self):
        found = a_console()
    ...
    def test_and_reads_the_same_way(self):
        found = a_console()
        found.chip.registers.dr = 0x1234
        found.chip.registers.sr.drc = True
        found.chip.registers.sr.rqm = True
    ...
    def test_finishing_a_wide_read_stops_the_part_asking(self):
        found = a_console()
        found.chip.registers.sr.rqm = True
    ...
    def test_an_address_that_is_neither_register_reads_nothing(self):
        self.assertEqual(a_console().read(0x7), 0)

    def test_and_writing_to_it_changes_nothing(self):
        found = a_console()
...
class SettleTest(unittest.TestCase):
    def test_a_part_already_asking_settles_at_once(self):
        found = a_console()
        found.chip.registers.sr.rqm = True

        self.assertEqual(found.settle(), 0)

    def test_a_part_that_never_asks_gives_up_rather_than_running_forever(self):
        found = a_console()

        with self.assertRaises(ports.NeverReady):
            found.settle(limit=50)

    def test_a_part_that_asks_after_a_while_settles_when_it_does(self):
        found = a_console()
...
class ExchangeTest(unittest.TestCase):
    def test_sending_a_word_settles_before_each_half(self):
        found = a_console()
        found.chip.registers.sr.rqm = True
    ...
    def test_taking_a_word_puts_the_halves_back_together(self):
        found = a_console()
    ...
    def test_sending_bytes_sends_each_one(self):
    ...
    def test_taking_bytes_takes_as_many_as_asked(self):
        found = a_console(fill=ALWAYS_ASKING)
        found.chip.registers.sr.rqm = True
