...
class ConstructionTest(unittest.TestCase):
    def test_a_processor_is_built_from_the_name_of_a_part(self):
        self.assertEqual(upd7725.Processor("upd7725").model.name, "upd7725")

    def test_the_default_part_is_the_larger_one(self):
...
class VersionTest(unittest.TestCase):
    ...
    def test_and_publishes_it_the_way_python_expects(self):
